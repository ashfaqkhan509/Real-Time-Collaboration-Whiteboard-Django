...
class DrawingUtils {
    ...
    /**
     * Draw a freehand path on the canvas
     * @param {CanvasRenderingContext2D} ctx - Canvas context
     * @param {Object} actionData - Drawing action data
     */
    ...
    static drawText(ctx, actionData) {
        ...
        ctx.fillStyle = actionData.color;
    ...
    static clearArea(ctx, actionData, canvas) {
        ...
        } else if (actionData.startX !== undefined && actionData.startY !== undefined &&
     ...
     * @param {CanvasRenderingContext2D} ctx - Canvas context
     * @param {Object} action - Drawing action
     * @param {HTMLCanvasElement} canvas - Canvas element
     */
